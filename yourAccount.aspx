...
<body>
    ...
    <div>
         <div id ="book_joint">
         <img src="Images/bookiejoint.jpg" style="width: 1337px; height: 195px" />
         </div>
        <div id="steps">
            <h3>Just few steps...</h3>
        </div>
        <div id="main" style="width:100%;">
            <div id="information" style="width:70%;">
            ...
            <h2>Login Information</h2><asp:Table runat="server">
                    <asp:TableRow>
                        <asp:TableCell>
                        ...
                        </asp:TableCell><asp:TableCell Enabled="false">
                        ...
                        </asp:TableCell></asp:TableRow></asp:Table></div><hr /> 
                  <div id="payment" style:"font-color= blue">
            <h2>Pay me by</h2><asp:RadioButton GroupName="Payment" ID="check" runat="server" text="Check" />
         ...
         <asp:Button id="registration_button" Text="Complete Registration" OnClick="registration_button_OnClick" runat="server" ValidationGroup="a" />--%>
                <asp:Button ID="back" runat="server" Text="Go To Main Page" OnClick="back_OnClick" Height="31px" Width="168px"/><asp:Button ID="update_button" runat="server" Text="Update" OnClick="update_button_Click" />
                <asp:Button ID="update_back_button" runat="server" Text="Update and Go to Main Page" OnClick="update_back_button_Click" Height="31px" Width="241px" /></div>
